...
export async function POST(req: NextRequest) {
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Código de Verificación Tgroup',
      ...
      <table role="presentation" style="background-color: #fff;  padding: 20px 60px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); font-family: Arial, sans-serif; line-height: 1.6; text-align: center;">
        <tr>
          <td>
            ...
            <p style="font-size: 24px; text-align: center; font-weight: bold; color: #4CAF50; border: 1px solid #4CAF50; border-radius: 10px; padding: 10px;">${code}</p>
            <p>Introducí este código en la aplicación para continuar.</p>
          </td>
        </tr>
      </table>
    </td>
